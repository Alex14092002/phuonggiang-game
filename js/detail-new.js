...
(async () => {
    ...
    const response = await fetch(
      `https://data-maygapthu-default-rtdb.firebaseio.com/new/${id_item}.json`
    );
    ...
    if (product) {
        ...
        <div class="w3-content" style="max-width:1200px">
            ...
            <div class="w3-row-padding w3-section">
              ...
              <div class="w3-col s4">
                <img class="demo w3-opacity w3-hover-opacity-off" src="${product.detail3}" style="width:100%; height: 100px ;cursor:pointer" onclick="currentDiv(2)">
              </div>
              <div class="w3-col s4">
    ...
    <div class="item-product col-12 col-md-6">
        ...
        <div class="buttons">
          <a href="../muangay-new.html?id=${product.id}" class="btn-hover color-11 btns">Mua Ngay</a>
          </div>
    </div>
