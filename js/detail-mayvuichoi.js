...
(async () => {
    ...
    const response = await fetch(
      `https://data-maygapthu-default-rtdb.firebaseio.com/mayvuichoi/${id_item}.json`
    );
    ...
    <div class="item-product col-12 col-md-6">
        ...
        <div class="buttons">
          <a href="../muangay.html?id=${product.id}" class="btn-hover color-11 btns">Mua Ngay</a>
          </div>
    </div>
  ...
  (async () => {
    ...
    const response = await fetch(
      `https://data-maygapthu-default-rtdb.firebaseio.com/mayvuichoi.json`
    );
